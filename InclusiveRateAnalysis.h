...
class InclusiveRateAnalysis {
 ...
 public:
  ...
  void GeneratePseudoData( Int_t _n_events = -1, Int_t _n_events_per_lund_file = 20000, const char* _dir_for_lund_files = "lund_files", Int_t start_number = 0, Double_t theta_min = 5, Double_t theta_max = 35, Double_t p_min=1.2, Double_t p_max = 10.6);
